        ...
        e.append && e.append.remove(),
          ...
          ("button" !== i && "both" !== i) ||
            ...
            this._get(e, "buttonImageOnly")
              ? (e.trigger = V("<img>").addClass(this._triggerClass).attr({
                  src: i,
                  alt: s,
                  title: s,
                }))
    ...
    V.widget("ui.slider", V.ui.mouse, {
      ...
      options: {
        ...
        classes: {
          ...
          "ui-loan-range": "ui-corner-all ui-widget-header",
        },
        distance: 0,
        max: 100,
        min: 0,
        ...
        t.range
          ? (!0 === t.range &&
            ...
            this.range && this.range.length
              ? (this._removeClass(
                  this.range,
                  "ui-loan-range-min ui-loan-range-max"
                ),
                this.range.css({
                  left: "",
                  bottom: "",
              ...
              : ((this.range = V("<div>").appendTo(this.element)),
                this._addClass(this.range, "ui-loan-range")),
            ("min" !== t.range && "max" !== t.range) ||
              this._addClass(this.range, "ui-loan-range-" + t.range))
              ...
              (i =
                ...
                !0 === r.options.range &&
                  ("horizontal" === r.orientation
                    ? (0 === t &&
                        r.range.stop(1, 1)[l ? "animate" : "css"](
                          {
                            left: i + "%",
                          },
                          a.animate
